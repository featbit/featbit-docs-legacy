...
> We refer to this as the '**temporary method**' because it's an interim measure while we better understand the specific needs and best practices of each customer. We invite you to [join our Discord](https://discord.gg/ytK9xGJSw3) server for further discussion on this topic, or you can email us at `contact@featbit.co` for more information.
...
Please let us know your thoughts by sending us an email at `contact@featbit.co` or by joining our [Discord](https://discord.gg/ytK9xGJSw3) server. We appreciate any practical suggestions that may assist you.
...
For language-specific integration, including FeatBit SDKs and OpenFeature support, see [SDK overview](/sdk/overview). This page focuses on how to avoid common feature flag implementation problems with project rules and coding agent skills in the AI era.
...
````md
---
name: featbit-feature-flags
description: Project-specific FeatBit feature flag implementation rules for the official website.
---

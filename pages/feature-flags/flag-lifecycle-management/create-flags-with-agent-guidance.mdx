...
![](../assets/flag-lifecycle-management/create-flags-with-agent-guidance/edit-permission.png)
...
![](../assets/flag-lifecycle-management/create-flags-with-agent-guidance/codex-cli.png)
